    ...
    <section className="py-32 md:py-40 lg:py-48 relative z-0 overflow-x-clip" id="home">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        ...
        <Star size={590} rotation={95} shouldSpin spinDuration="28s" shouldRotate rotateDuration="8s">
          <StarImg className="size-8 dark:text-[#fbc7d4] text-[#9796f0]" />
        </Star>
        <Star size={530} rotation={190} shouldSpin spinDuration="26s" shouldRotate rotateDuration="4s">
          <SparkleImg className="size-10 dark:text-[#fbc7d4]/20 text-[#9796f0]/20" />
        </Star>
        ...
        <Star size={370} rotation={120} shouldSpin spinDuration="20s" shouldRotate rotateDuration="4s">
          <SparkleImg className="size-5 dark:text-[#fbc7d4]/20 text-[#9796f0]/40"/>
        </Star>
      </div>
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <h1 className="font-serif text-3xl md:text-5xl text-center tracking-wide uppercase dark:text-white text-gray-800">Building tech today for a better tomorrow</h1>
          <p className="mt-4 text-center dark:text-white/60 text-gray-800/60 md:text-lg">
          ...
          <div className="relative flex flex-col md:flex-row justify-center items-center mt-8 gap-4 z-20">
            <div className="button-wrapper z-20 mt-12">
              <a href="/docs/RamanaCV.pdf" target="_blank">
                <button className="button-content inline-flex justify-center items-center gap-2 h-12 px-6 text-gray-900 bg-white rounded-xl duration-300">
